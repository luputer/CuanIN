        ...
        <ImageCropperDialog
            ...
            onCrop={async (croppedFile) => {
                if (cropperMode === "avatar") {
                    ...
                    const url = await avatarUpload.handleFileUpload(croppedFile, originalFile as File);
                    if (url) {
                    ...
                    const url = await bannerUpload.handleFileUpload(croppedFile, originalFile as File);
                    if (url) {
                        setValue("banner", url, { shouldDirty: true, shouldValidate: true });
                    }
                }
            }}
