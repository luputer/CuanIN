            ...
            >
              <div className="flex flex-col gap-3 pb-2 sm:flex-row sm:items-start sm:justify-between">
                ...
                {status === "authenticated" ? (
                  <div className="flex flex-col gap-2 rounded-lg border border-cyan-100 bg-cyan-50 px-3 py-2 sm:items-end">
                    <div className="max-w-64 truncate text-xs font-medium text-cyan-700">
                      Login sebagai {session.user.email}
                    </div>
                    <button
                      type="button"
                      onClick={handleCheckoutSignOut}
                      className="w-fit text-xs font-semibold text-red-500 transition hover:text-red-600 hover:underline"
                    >
                      Logout
                    </button>
                  </div>
                  ...
                  <button
                    ...
                    className="flex w-fit items-center gap-2 rounded-lg border border-slate-300 bg-white px-3 py-2 text-xs font-semibold text-slate-700 transition hover:border-cyan-300 hover:bg-cyan-50 hover:text-cyan-700"
                  >
          ...
          <div className="space-y-6 lg:sticky lg:top-24 lg:col-span-2 lg:h-fit lg:self-start">
            ...
            <div className="rounded-xl border border-slate-300 bg-white p-5">
              ...
              <div className="mt-2 flex gap-3">
                ...
                <button className="rounded-xl bg-yellow-300 px-5 py-2.5 text-sm font-medium text-slate-800 hover:bg-yellow-400">
                  Pakai
                </button>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-slate-300 bg-white p-6">
              ...
              {isBuyingOwnProduct && (
                <div className="mb-4 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-xs text-amber-700">
                  Kamu sedang login sebagai pemilik produk ini. Logout atau
                  gunakan akun pembeli untuk melakukan testing checkout.
                </div>
              )}
