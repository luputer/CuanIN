  ...
  return (
    <div className="flex items-center">
      <div className="flex items-center gap-2 pr-2">
        <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-cyan-50 text-cyan-700">
          {icon}
        </div>
        ...
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
          ...
          <Popover>
            <PopoverTrigger asChild>
              <button type="button"
                className="flex size-10 items-center justify-center rounded-full hover:bg-slate-100 cursor-pointer border border-slate-200 transition-all duration-200"
              >
                <ShareNetworkIcon className="size-5 text-slate-600" />
              </button>
            </PopoverTrigger>
            <PopoverContent className="w-80 p-4 rounded-xl border border-slate-200 bg-white shadow-xl" align="end">
              <div className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  >
                    <div className="size-8 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 transition-all duration-200 group-hover:scale-110">
                  ...
                  >
                    <div className="size-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 transition-all duration-200 group-hover:scale-110">
                  ...
                  >
                    <div className="size-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-900 transition-all duration-200 group-hover:scale-110">
                ...
                {navigatorShareSupported && (
                  ...
                  >
                    <ShareNetworkIcon className="size-4 text-slate-500" />
        ...
        <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-5">
          ...
          <div className="flex flex-col gap-4 lg:col-span-3">
            ...
            <div className="flex flex-col gap-4 rounded-xl border border-slate-300 bg-white p-6 shadow-[0_-4px_0px_0px_rgba(0,146,184,100)] md:p-8">
              ...
              <div className="flex items-center gap-2">
                <div className="flex size-8 items-center justify-center rounded-full bg-yellow-200 text-xs font-bold">
                ...
                <div className="flex flex-wrap gap-2 mt-1">
                  {allImages.map((img, idx) => (
                    <button type="button"
                      ...
                      className={`relative size-16 overflow-hidden rounded-xl border-2 transition-all duration-200 cursor-pointer ${activeImageIndex === idx ? "border-cyan-600 ring-2 ring-cyan-100" : "border-slate-200 hover:border-slate-300" }`}
                    >
                      <Image
                        src={img}
            ...
            <div className="rounded-2xl border border-slate-300 bg-white p-6 shadow-sm">
              ...
              {isWebinarCompleted ? (
                ...
                <Link href={`/${slug}/${productSlug}/checkout`}>
                  <button type="button" className="mt-5 w-full cursor-pointer rounded-xl bg-cyan-600 py-3 text-lg font-semibold text-white shadow-sm hover:bg-cyan-700">
