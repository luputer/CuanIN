      ...
      <div className="min-h-screen bg-slate-50 pb-16 animate-pulse">
        ...
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="relative z-10 -mt-12 flex flex-col items-center text-center md:-mt-16">
            <div className="size-24 rounded-full border-4 border-white bg-slate-200 shadow-md md:size-32" />
    ...
    <div className="min-h-screen bg-slate-50 pb-16">
      ...
      <div className="relative h-32 w-full overflow-hidden bg-slate-200 md:h-48">
        {creator.banner ? (
          ...
          <div className="size-full bg-gradient-to-r from-cyan-500 to-blue-600 opacity-20" />
        )}
      </div>
      ...
      <div className="mx-auto max-w-6xl px-4">
        {/* ── Profile Section ── */}
        <div className="relative z-10 -mt-12 flex flex-col items-center text-center md:-mt-16">
          <Avatar className="size-24 overflow-hidden rounded-full border-4 border-white bg-white p-1 shadow-md md:size-32">
        ...
        <div className="mt-8 rounded-xl border border-slate-200 bg-white px-10 pt-10 pb-12 shadow-sm">
            ...
            <div className="flex w-full items-center gap-3 md:w-auto">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <button type="button" className="flex size-10 shrink-0 cursor-pointer items-center justify-center rounded-full border border-slate-400 bg-white text-slate-600 transition-all duration-200 ease-out hover:bg-slate-50 hover:text-slate-800 hover:translate-x-[1px] hover:translate-y-[1px] !shadow-none m-0 p-0 box-border">
          ...
          {filtered.length === 0 ? (
            <div className="flex flex-col items-center justify-center gap-2 py-24 text-slate-400">
              <ImagesIcon className="size-12" strokeWidth={1} />
              <p className="text-sm">
                {searchQuery
