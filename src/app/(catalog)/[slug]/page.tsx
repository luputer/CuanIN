...
function ProductCard({
    ...
    return (
        <Link href={`/${slug}/${productSlug}`} className="block">
            <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden hover:shadow-md transition-shadow duration-200 cursor-pointer group h-full">
                {/* Thumbnail */}
                ...
                {/* Info */}
                <div className="p-4 space-y-1.5 flex flex-col justify-between" style={{ height: 'calc(100% - 75%)' }}>
                    <div>
                        <p className="font-semibold text-slate-800 text-sm leading-snug group-hover:text-blue-600 transition-colors line-clamp-2 mb-1">
                            {name}
                        </p>
                    ...
                    <div>
                        {isGratis ? (
                            <span className="inline-block text-xs font-medium text-green-600 bg-green-50 border border-green-200 rounded-full px-3 py-0.5 mt-auto">
                                Gratis
                            </span>
                        ) : (
                            <span className="inline-block text-xs font-medium text-blue-600 bg-blue-50 border border-blue-200 rounded-full px-3 py-0.5 mt-auto">
