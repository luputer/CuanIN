                        ...
                        {showIndicator && (
                            <div className={`text-sm ${slugAvailable === false ? "text-red-500" : "text-slate-400"}`}>
                                {isCheckingSlug
                                    ...
                                    : slugAvailable === false
                                        ? <div className="flex items-center gap-2 text-red-600"><XIcon className="size-3" weight="bold" /> Slug sudah dipakai orang lain, pilih nama lain.</div>
                                        : <div className="flex items-center gap-2 text-green-600"><CheckIcon className="size-3" weight="bold" /> Link tersedia</div>}
                            </div>
                        )}
                        {!showIndicator && (
