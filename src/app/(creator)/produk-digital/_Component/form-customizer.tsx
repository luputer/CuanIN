...
function SortableFieldItem({
    ...
    return (
        <div
            ref={setNodeRef}
            style={style}
            className={`bg-white border border-slate-400 rounded-lg py-5 pl-3 sm:pl-4 pr-4 sm:pr-5 flex items-center gap-3 sm:gap-4 ${isDragging ? "shadow-lg ring-2 ring-cyan-500 z-50" : ""}`}
        >
