                ...
                <div className="w-full max-w-lg rounded-2xl border-2 border-slate-800 bg-white p-6 sm:p-10 shadow-[0px_4px_0px_rgba(29,41,61)]">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
                        ...
                        <button
                            type="submit"
                            disabled={isPending}
                            className="cursor-pointer mt-4 w-full rounded-lg border-2 border-slate-800 bg-yellow-200 py-2.5 text-lg font-semibold text-slate-800 shadow-[0px_2px_0px_rgba(29,41,61)] transition duration-200 ease-out hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none"
                        >
                            {isPending
                                ? "Mendaftar..."
                                : fromGoogle
