        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-10">
            <div className="w-full max-w-md space-y-4">
                ...
                <div className="bg-white border border-slate-200 rounded-2xl p-8 flex flex-col items-center text-center gap-3">
                    <div className="size-20 rounded-full bg-red-100 flex items-center justify-center mb-2">
                        <XCircleIcon className="size-12 text-red-500" weight="fill" />
                    </div>
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-xl p-4 w-full text-left mt-2">
                        ...
                        <ul className="text-xs text-red-600 mt-2 gap-1 list-disc list-inside flex flex-col">
