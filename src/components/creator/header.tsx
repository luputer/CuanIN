"use client";
import { CaretDownIcon, UserIcon, SignOutIcon, ListIcon, ShoppingBagIcon, BellIcon, CheckIcon } from "@phosphor-icons/react";
        ...
        <header className="sticky top-0 z-50 bg-white px-4 sm:px-6 py-3 flex items-center justify-between border-b border-slate-800">
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="relative" ref={notifRef}>
                    ...
                    {notifOpen && (
                        <div className="absolute right-0 top-12 w-[340px] bg-white border border-slate-800 rounded-xl shadow-[0px_2px_0px_#000] overflow-hidden z-50">
                            {/* Header */}
                            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200">
                                <span className="font-bold text-sm text-slate-800">Notifikasi Terbaru</span>
                                {unreadCount > 0 && (
                                    <span className="text-[11px] font-bold bg-red-100 text-red-600 border border-red-300 rounded-full px-2 py-0.5">
                                        {unreadCount} Unread
                                    </span>
                                )}
                            </div>
