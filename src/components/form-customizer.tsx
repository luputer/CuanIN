...
function SortableFieldItem({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`flex items-center gap-3 rounded-lg border border-slate-800 bg-white py-5 pr-4 pl-3 sm:gap-4 sm:pr-5 sm:pl-4 ${isDragging ? "z-50 shadow-lg ring-2 ring-cyan-500" : ""}`}
    >
      ...
      <div className="flex-1 space-y-4">
        <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
          <div className="w-full flex-1 border-b border-slate-300 md:max-w-[60%]">
            <input
              ...
              className="w-full bg-transparent py-2 text-[15px] font-medium text-slate-700 focus:outline-none"
            />
          </div>
          <div className="flex items-center gap-4">
            <div className="group relative">
              <select
                ...
                className="cursor-pointer appearance-none rounded-md border border-slate-300 bg-white py-1.5 pr-9 pl-3 text-[15px] font-medium text-slate-600 transition-colors hover:border-slate-400 focus:outline-none"
              >
        ...
        <div className="pt-2">
          <h4 className="mb-2 text-[15px] font-medium text-slate-700">
            Jawaban
          </h4>
          {field.type === "SHORT" ? (
            <div className="border-b border-slate-300 pb-2 text-[15px] text-slate-400">
            ...
            <div className="space-y-3">
              {field.options?.map((option, index) => (
                <div key={index} className="flex items-center gap-3">
                  <input
                    ...
                    className="flex-1 border-b border-slate-300 py-1 text-[15px] focus:border-[#00B4D8] focus:outline-none"
              ...
              <button
                ...
                className="cursor-pointer text-[15px] font-medium text-cyan-600 transition-colors hover:text-cyan-700"
              >
                + Tambah Opsi
              </button>
            </div>
