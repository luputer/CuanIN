...
export default function CtaSection() {
  return (
    <section className="relative max-w-6xl w-full py-16 md:py-30 px-4 md:px-6 mx-auto">
      <div className="relative bg-yellow-200 py-10 md:py-16 rounded-xl border-2 border-slate-800 shadow-[2px_3px_0px_rgba(29,41,61)] px-4 md:px-12 text-center">
        {/* Dekorasi atas kiri */}
        ...
        {/* Konten text */}
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-8 md:mb-10 text-slate-800 leading-tight">
