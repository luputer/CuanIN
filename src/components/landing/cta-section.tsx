...
export default function CtaSection() {
  return (
    <section className="relative max-w-6xl w-full pb-16 md:pb-36 pt-10 mx-auto px-4 sm:px-6">
      <div className="relative bg-cuan-cyan/20 py-8 md:py-16 rounded-xl border-2 border-slate-800 shadow-[2px_2px_0px_#000] px-4 md:px-12 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-xl sm:text-3xl md:text-4xl font-medium mb-6 md:mb-10 text-slate-800 leading-tight">
