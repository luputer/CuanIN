        ...
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            ...
            >
                ...
                <DialogHeader className="flex flex-row justify-between items-center text-left pr-4 pl-6 py-4">
                    <DialogTitle className="text-lg">Edit Gambar</DialogTitle>
                    <DialogClose asChild>
                        <button className="text-slate-400 hover:text-cuan-blue transition-colors p-1 cursor-pointer outline-none border-none appearance-none bg-transparent">
                ...
                <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
                    ...
                    <div className="w-full md:w-[280px] p-6 border-t md:border-t-0 md:border-l border-slate-100 flex flex-col justify-between bg-slate-50 shrink-0">
                        ...
                        <DialogFooter className="flex items-center gap-3 pt-6 border-t border-slate-200/60 mt-6 md:mt-0">
                            <button
                                type="button"
                                onClick={onClose}
                                className="flex-1 inline-flex items-center justify-center px-4 h-10 text-sm font-semibold border-1 border-slate-800 rounded-lg shadow-[1px_1px_0px_#000] transition-all duration-200 ease-out hover:translate-x-px hover:translate-y-px hover:shadow-none active:translate-x-px active:translate-y-px active:shadow-none bg-white hover:bg-slate-50 text-slate-800 cursor-pointer"
                            >
                                Batal
                            </button>
                            <button
                                type="button"
                                onClick={handleSave}
                                className="flex-1 inline-flex items-center justify-center px-4 h-10 text-sm font-semibold border-1 border-slate-800 rounded-lg shadow-[1px_1px_0px_#000] transition-all duration-200 ease-out hover:translate-x-px hover:translate-y-px hover:shadow-none active:translate-x-px active:translate-y-px active:shadow-none bg-cuan-blue/80 hover:bg-cuan-blue text-white cursor-pointer"
                            >
                                Terapkan
                            </button>
                        </DialogFooter>
